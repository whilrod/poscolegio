<?php
	...
	*/
	...
	$aColumnas = array( 'idcarrito','itemcarrito', 'descripcioncarrito','cantidadcarrito','preciocarrito','formapagocarrito');
	
	/* columna indexada */
	$sIndexColumn = "idcarrito";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='calzadoVenta.php?item=".$aRow['itemcarrito']."'><span class='btn btn-danger'>Eliminar</span></a></td>";
