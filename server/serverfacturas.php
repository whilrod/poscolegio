<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'numerofactura','cliente','numeroventa','fechafactura','abona','valorfactura','saldopendiente','estado_factura');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='calzadoVenta.php?item=".$aRow['id']."'><span class='btn btn-success'>Agregar</span></a></td>";
