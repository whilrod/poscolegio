<?php
	...
	*/
	...
	$aColumnas = array(  'item','tipo','descripcion','genero','talla','cantidada','cantidadb');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		//$row[]="<td>X</td>";
		$row[] = "<td><a href='editarmercancia.php?item=".$aRow['item']."'><span class='btn btn-success'>Editar</span></a></td>";
