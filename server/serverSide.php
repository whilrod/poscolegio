<?php
	...
	*/
	...
	$aColumnas = array( 'item', 'descripcion','genero','talla', 'precio','cantidadb','cantidada');
	
	/* columna indexada */
	$sIndexColumn = "descripcion";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		//$row[]=<td></td>;
			...
			$row[] = "<td><a href='uniformesVenta.php?item=".$aRow['item']."'><span class='btn btn-success'>Agregar</span></a></td>";
