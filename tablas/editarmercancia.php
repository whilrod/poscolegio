...
<html lang="es">
   ...
   <!--- <link rel="stylesheet" href="../css/estilotablas.css">-->
    ...
    <div class="signUp_user caja col-sm-4">
        <div class="container_signUp_user">
			...
			<div class="">
				<h3 style="text-align:center">EDITAR STOCK</h3>
			</div>
			
					
                <form class="form-horizontal" method="POST" action="guardastock.php" autocomplete="off">
  ...
  <input name="almacen" name="almacen" id="almacen" class="form-control col-sm-9" value=<?php echo $cantidada; ?> /></span>
  <span class="input-group-text">BODEGA
  <input name="bodega" name="bodega" id="bodega" class="form-control col-sm-9" value=<?php echo $cantidadb; ?> /></span>
 </div> <br>
			    ...
			    <div class="form-group">
					<div class="col-sm-offset-6 col-sm-12 ">
						<a href="mueveMercancia.php" class="btn btn-primary">Regresar</a>
