...
<div style="height:50px" class="banner"></div>
    ...
    <div class="">
            <h6>&nbsp</h6>
    				<h2 style="text-align:center">Calzado</h2><br>
    ...
    <div class="container">
        <div class="row">
            ...
            <a href="./carrito.php"><img class="cart" src="../images/shopping-cart2.png" width="40" /></a>
            <br>&nbsp;
            </div>    
        </div>    
    </div>			
    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="calzado" style="width:100%" class="table table-hover table-striped table-bordered table-condensed">
...
<script>
 $(document).ready(function(){
				$('#calzado').DataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../server/servercalzado.php"
				});	
			});
</script>
