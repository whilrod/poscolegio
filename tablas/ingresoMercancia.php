...
<html lang="es">
  ...
  <body>
    ...
    <div class="">
            <h6>&nbsp</h6>
    				<h2 style="text-align:center">Mercancia y Productos</h2><br>
    </div>
        <div class="container">
        <div class="row">
            <div class="col-lg-12">            
...
<div id="openModal" class="modalDialog">
	<div>
		...
		<h2>Entrada Nueva</h2>
		<p>Referencia debe ser creada</p>
		<form name="nuevo" action="https://uniformescolegio.000webhostapp.com/tablas/guardaNuevo.php" method="post" autocomplete="off">
		    <div class="row container">
		        <input type="text" class="form-control entrada" id="item" name="item" placeholder="Referencia" required>
...
<div class="foot">
    ...
    $('#productos').DataTable( {
        ...
        bProcessing: true,
		bServerSide: true,
		sAjaxSource: "../server/serverProductos.php",
        lengthMenu: [
            [5, 10, 20, -1],
            [5, 10, 20, 'All'],
        ],
