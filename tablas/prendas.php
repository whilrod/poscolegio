...
<div style="height:50px" class="banner"></div>
    ...
    <div class="">
            <h6>&nbsp</h6>
    				<h2 style="text-align:center">Prendas y Accesorios</h2><br>
    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="prendas" style="width:100%" class="table table-hover table-striped table-bordered dislay">
...
<script>
 $(document).ready(function(){
				$('#prendas').DataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../server/serversueltas.php"
				});	
			});
</script>
