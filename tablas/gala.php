...
<div style="height:50px" class="banner"></div>
    ...
    <div class="">
            <h6>&nbsp</h6>
    				<h2 style="text-align:center">Uniformes de Gala</h2><br>
    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="gala" style="width:100%" class="table table-hover table-striped table-bordered table-condensed">
...
<script>
 $(document).ready(function(){
				$('#gala').DataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../server/servergala.php"
				});	
			});
</script>
